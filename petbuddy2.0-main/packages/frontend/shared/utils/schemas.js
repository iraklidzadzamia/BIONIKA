...
const phoneSchema = z.string().regex(/^\+?[1-9]\d{9,14}$/, "Invalid phone number").optional().or(z.literal(""));
...
export const registerCompanySchema = z.object({
  ...
  user: registerUserSchema.extend({
    tosAccepted: z.boolean().refine((val) => val === true, "You must accept the Terms of Service and Privacy Policy"),
  }),
});
